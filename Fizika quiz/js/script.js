...
function chkUser() {
    ...
    if (tempName == null || tempName == '' || tempName == 'undefined') {
        ...
        if (
            ...
            errH.innerHTML = tempName + ', Kalitingizni kiriting!'; // display this text
...
function askPass() {
    ...
    errH.innerHTML = tempName + ', Iltimos kalini taqdim eting.'; // display this line with user's name
}
...
function chkPass(btn) {
    ...
    if (pass.value == 1730) {
        ...
        setTimeout(function() {
            ...
            errH.innerHTML = 'Tariklayman!'; // in first line

            err.innerHTML = 'Togri parol kiritildi!'; // in 2nd line
            err.style.color = '#28a745';

            btn.innerHTML = 'Testni boshlash &gt;'; // replace text of input box to this
        ...
        setTimeout(function() {
            ...
            err.style.color = '#dc3545';
            err.innerHTML = 'Parol notogri';

            btn.innerHTML = 'Qayta urinib korish';
            btn.removeAttribute('disabled');
...
function resetErr() {
    ...
    submitBtn.innerHTML = 'Tekshirish';
...
function topping(n) {
    ...
    if (n == totQ.length - 1)
        document.getElementById('next-button').innerHTML = 'Natija';
    else if (n == totQ.length) {
        document.getElementById('next-button').innerHTML = 'Javob yoq';
        nextBtn.setAttribute('disabled', 'disabled');
    } else document.getElementById('next-button').innerHTML = 'Keyin';
...
function showResult(percentage, ca) {
    if (percentage == 100) {
        RColor = 'teal';
        resultFb.innerHTML = 'Super! <br> Juda ham zor';
        correctAns.innerHTML = 'Togri javoblar: ' + ca;
    } else if (percentage >= 80) {
        RColor = 'green';
        resultFb.innerHTML = 'Alo natija.';
        correctAns.innerHTML = 'Togri javoblar: ' + ca;
    } else if (percentage >= 60) {
        RColor = 'blue';
        resultFb.innerHTML = 'Yaxshi natija.';
        correctAns.innerHTML = 'Togri javoblar: ' + ca;
    } else if (percentage >= 50) {
        RColor = 'orange';
        resultFb.innerHTML = 'Yaxshi. <br>Ammo qayta urinib korishni maslahat beramiz';
        correctAns.innerHTML = 'Togri javoblar: ' + ca;
    } else {
        RColor = 'red';
        resultFb.innerHTML = 'Afsuski muvaffaqiyatsiz... <br> Keyingi safar omad tilaymiz';
        correctAns.innerHTML = 'Togri javoblar: ' + ca;
    }
